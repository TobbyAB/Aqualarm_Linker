...
{
    if (HAL_SUBGHZ_DeInit(&hsubghz) != HAL_OK)
    {
      Error_Handler();
    }
}
...
void SUBGRF_SetPacketParams( PacketParams_t *packetParams )
{
    ...
    case PACKET_TYPE_GFSK:
        ...
        else if( packetParams->Params.Gfsk.CrcLength == RADIO_CRC_2_BYTES_INV )
        {
            SUBGRF_SetCrcSeed( 0xFFFF );
            SUBGRF_SetCrcPolynomial( 0X8005 );
            crcVal = RADIO_CRC_2_BYTES_INV;
        }
        else
        {
